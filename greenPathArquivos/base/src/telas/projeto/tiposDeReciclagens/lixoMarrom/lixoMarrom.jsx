...
export default function lixoMarrom({navigation}) {
    ...
    <SafeAreaView style={styles.scrollview}>
      <ScrollView>
        ...
        <View style={styles.containerLearn}>
          ...
          <Image
            source={require('../../../../../res/img/batata.png')}
            style={styles.imagem}
          />
        </View>
        ...
        <View style={styles.containerLearn}>
          ...
          <Image
            source={require('../../../../../res/img/banana.png')}
            style={styles.imagem}
          />
        </View>
        ...
        <View style={styles.containerLearn}>
          ...
          <Image
            source={require('../../../../../res/img/laranja.png')}
            style={styles.imagem}
          />
        </View>
